...
class BookControllerTest {
    ...
    void Given_a_valid_book_body_to_create_should_return_201() throws Exception {
        when(bookService.addBook(any(BookRequest.class))).thenReturn("Book added successfully");
    ...
    void Given_a_valid_book_body_to_update_should_return_200() throws Exception {
        when(bookService.updateBook(any(BookRequest.class))).thenReturn("Book updated successfully");
